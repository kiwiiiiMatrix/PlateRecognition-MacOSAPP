...
class Ui_MainWindow(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        parser.add_argument('--weights', nargs='+', type=str,
                            default='weights/plate_detect.pt', help='model.pt path(s)')
    ...
    def button_image_open(self):
        ...
        plate_rec_model = init_model(self.device, 'weights/plate_rec_color.pth', is_color=True)  # 初始化识别模型
        # 算参数量
