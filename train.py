        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            if rank in [-1, 0]:
                ...
                if plots and ni < 3:
                    ...
                    #     tb_writer.add_graph(model, imgs_for_test)  # add model to tensorboard
...
if __name__ == '__main__':
    ...
    parser.add_argument('--log-imgs_for_test', type=int, default=16, help='number of images for W&B logging, max 100')
